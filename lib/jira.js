...
(function() {
     ...
     * @param callback
     */
    this.getSprintsForRapidView = function(rapidViewId, callback) {
    ...
    // ## Get a comment belonging to an issue ##
    // ### Takes ###
    //
    // *  issueKey: the key for the issue
     ...
     * @param callback
     */
    this.getCommentForIssue = function(issueKey, commentId, callback) {
        var options = {
          rejectUnauthorized: this.strictSSL,
          uri: this.makeUri('/issue/' + issueKey + '/comment/' + commentId),
          method: 'GET',
          json:true
        };
